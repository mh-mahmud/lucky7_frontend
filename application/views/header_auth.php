	...
	<div class="col-sm-10 text-right">
		<div class="main-menu">
			<ul id="main-menu">
				<div class="footer-top-right">
					<ul>
						<li><a class="btn btn-danger" href="javascript:void(0);" onclick="return loginForm();">Sign In</a></li>
						<li><a class="btn btn-warning" href="javascript:void(0);" onclick="return registrationForm();">Register</a></li>
						<!-- <li class="ng-star-inserted">
							<a class="logged-in-user btn btn-info" href="javascript:void(0);">
									<span class="user-balance">
										<span class="top-balance">More</span>
							...
							<ul class="sub-menu " style="overflow: visible; background-color: #376f99; flex-wrap: wrap!important;height: auto!important;">
								<?php //foreach ($get_game_page as $gval): ?>
									<li style="width: 100%">
										<a  style="color: #FFF;" href="<?php //echo base_url("game/".$gval->id) ?>" target="_blank"><?php // echo $gval->page_name ?></a>
									</li>
								<?php //endforeach; ?>
							</ul>
						</li>  -->
