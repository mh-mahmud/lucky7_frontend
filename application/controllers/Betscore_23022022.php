	...
	*********************************************/
	...
	public function action_coin() {
		...
		if($game_status=="WIN" && $head_tile_status==1) {
			$x = array (
				'wstatues' => '<div class=\'side-a \'><a href=\'\'><img style=\'width: 100%;height: 100%;border: 22px solid #f00;border-radius: 50%;\' src=\'assets/game2/images/head.png\'></a><span class=\'win\'></span><span class=\'resultwin\'>You are win</span></div><div class=\'side-a hideMe\'><img style=\'width: 100%;height: 100%;border: 22px solid #f00;border-radius: 50%; padding:2px;\' src=\'assets/game2/images/coin.gif\'></div>',
			...
			$x = array (
				'wstatues' => '<div class=\'side-a \'><a href=\'\'><img style=\'width: 100%;height: 100%;border: 22px solid #f00;border-radius: 50%;\' src=\'assets/game2/images/tail.png\'></a><span class=\'win\'></span><span class=\'resultwin\'>You are win</span></div><div class=\'side-a hideMe\'><img style=\'width: 100%;height: 100%;border: 22px solid #f00;border-radius: 50%; padding:2px;\' src=\'assets/game2/images/coin.gif\'></div>',
				'b' => '<div class=\'loading hideMe\'><span class=\'\'>Loadding....</span></div>
				            <div class=\'result side-a \'><span class=\'\'>You are win</span></div>',
				'c' => '<div class=\'loading hideMe\'><span class=\'\'></span></div>
				            <div class=\'result side-a \'><span class=\'\'>Refresh and continue</span></div>',
